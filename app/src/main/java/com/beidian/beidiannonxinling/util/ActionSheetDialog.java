...
public class ActionSheetDialog {
     ...
     * @return
     */
    public ActionSheetDialog addSheetItem(String strItem,  ActionSheetDialog.SheetItemColor color,
                                                                      ActionSheetDialog.OnSheetItemClickListener listener) {
        if (sheetItemList == null) {
            sheetItemList = new ArrayList< SheetItem>();
        }
        sheetItemList.add(new ActionSheetDialog.SheetItem(strItem, color, listener));
        return this;
    }
    ...
    private void setSheetItems() {
        ...
        for (int i = 1; i <= size; i++) {
            final int index = i;
             ActionSheetDialog.SheetItem sheetItem = sheetItemList.get(i - 1);
            String strItem = sheetItem.name;
             ActionSheetDialog.SheetItemColor color = sheetItem.color;
            final  ActionSheetDialog.OnSheetItemClickListener listener = sheetItem.itemClickListener;
            ...
            // 字体颜色
            if (color == null) {
                textView.setTextColor(Color.parseColor( ActionSheetDialog.SheetItemColor.Blue
                        .getName()));
            } else {
