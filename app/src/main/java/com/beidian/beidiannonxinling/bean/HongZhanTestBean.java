...
public class HongZhanTestBean {

    private List<ParentListBean> parentList;

    public static HongZhanTestBean objectFromData(String str, String key) {

        try {
            JSONObject jsonObject = new JSONObject(str);

            return new Gson().fromJson(jsonObject.getString(str), HongZhanTestBean.class);
